<aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
    <div class="sidebar-header d-flex align-items-center justify-content-start">
        <a href="../dashboard/index.html" class="navbar-brand">
            ...
            <!--logo End-->
            <h4 class="logo-title">LM Crackers</h4>
        </a>
    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                <!-- dashboard - start -->
                <li class="nav-item">
                    <a id="dashboard-link" class="nav-link" aria-current="page" href="../dashboard/index.php">
                        <i class="icon">
                ...
                <!-- homebanner - start -->
                <li class="nav-item">
                    <a id="homebanner-link" class="nav-link" aria-current="page" href="../dashboard/banner.php">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                class="icon-20">
                                <path opacity="0.4"
                ...
                <!-- our shop - start -->
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#shop-sidebar" role="button"
                        aria-expanded="false" aria-controls="shop-sidebar">
                        <i class="icon">
                    ...
                    <ul class="sub-nav collapse" id="shop-sidebar" data-bs-parent="#sidebar-menu">
                        <!-- category - start -->
                        <li class="nav-item">
                            <a class="nav-link " href="../dashboard/category.php">
                                <i class="icon">
                        ...
                        <!-- coupon - start -->
                        <li class="nav-item">
                            <a class="nav-link " href="../dashboard/promocode.php" >
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                        viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                ...
                <!-- orders - start -->
                <li class="nav-item">
                    <a id="product-link" class="nav-link" aria-current="page" href="../dashboard/orders.php">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                class="icon-20">
                                <path opacity="0.4"
                ...
                <!-- delivery - start-->
                <li class="nav-item">
                    <a id="product-link" class="nav-link" aria-current="page" href="../dashboard/delivery.php">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                class="icon-20">
                                <path opacity="0.4"
                ...
                <!-- billing - start-->
                <li class="nav-item">
                    <a id="product-link" class="nav-link" aria-current="page" href="../dashboard/billing.php">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                class="icon-20">
                                <path opacity="0.4"
                ...
                <!-- report - start -->
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="../dashboard/commingsoon.php">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                class="icon-20">
                                <path opacity="0.4"
                ...
                <!-- shopsettings - start -->
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="../dashboard/settings.php">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4"
                        ...
                        <span class="item-name">Shop Settings</span>
                    </a>
                </li>
                <!-- shopsettings - end -->
                <!-- shopcustomization - start -->
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="../dashboard/commingsoon.php">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                        ...
                        <span class="item-name">Shop Customization</span>
                    </a>
                </li>
                <!-- shopcustomization - end -->
                <!-- logout - start -->
